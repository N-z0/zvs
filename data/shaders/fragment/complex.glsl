...
{	
	...
	vec3 diffuse = GetDiffuseLight(light,frag_diffus.rgb,normal_vector,light_direction);
	vec3 specular = GetSpecularLight(light,normal_vector,light_direction,eye_vector,frag_highlight);
